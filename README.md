...
一个集成了 Google Gemini AI 的股票投资分析系统，采用 **AlphaG (G=B+M) 模型**和**五大支柱投资框架**，为投资者提供专业的股票分析和投资建议。
...
3. **AlphaG (G=B+M) 模型分析**
   - **G (收益 Gain)**: 当前价格、52周区间、技术指标
   - **B (基本面 Basics)**: 营收增长、利润率、PE/PEG 估值
   - **M (动量 Momentum)**: 动量评分、VIX恐慌指数、期权市场数据、宏观经济指标
...
6. **AI 投资分析报告**
   ...
   - 包含投资风格分析、AlphaG (G=B+M) 深度解构、五大支柱检查、具体交易策略
...
**AlphaG 投资模型**，将股票收益分解为两个核心维度：

- **G (收益 Gain)**: 当前市场价格和收益潜力
- **B (基本面 Basics)**: 公司的财务健康状况和盈利能力
- **M (动量 Momentum)**: 市场对股票的动量和情绪
