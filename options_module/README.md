...
这是 Alpha P 智能投研系统的**期权分析模块**，基于 `P = F + S` 模型，为股票期权交易提供智能策略建议。

## 🎯 核心功能

### 1. Alpha P 模型分析
- **P (Potential/Price)**: 综合潜力分 (0-100)
- **F (Fundamentals)**: 基本面锚点 (0-10)
  - 营收增长率
  - 利润率
  - PEG估值
- **S (Sentiment)**: 市场情绪 (0-10)
  - 技术趋势 (MA50/MA200)
  - 乖离率
  - 超买超卖判断
...
| Alpha P 诊断 | 对应策略 | 说明 |
|-------------|---------|------|
| F优 + S低 (黄金坑) | 🛡️ Sell Put (安全建仓) | 公司好但被错杀，在支撑位卖Put |
| F优 + S高 (主升浪) | 📈 Long Call / Bull Spread | 基本面好且情绪爆发 |
| 持仓中 + S过热 | 📤 Covered Call | 止盈增强 |
| F差 (垃圾股) | ⛔ 禁止操作 | 基本面恶化，严禁卖Put |
