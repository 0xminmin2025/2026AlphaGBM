  ...
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        updatedAt: '2026-02-26',
        sections: [
          { id: 'trap-1', titleZh: '合约乘数陷阱', titleEn: 'Contract Multiplier Trap' },
          { id: 'trap-2', titleZh: '方向倒错', titleEn: 'Wrong Direction' },
          { id: 'trap-3', titleZh: '盘后暗杀', titleEn: 'After-Hours Exercise' },
          { id: 'trap-4', titleZh: '单腿被斩', titleEn: 'Partial Assignment' },
          { id: 'trap-5', titleZh: '被提前拆腿', titleEn: 'Early Exercise Risk' },
        ],
      },
      {
        id: 'ch09',
        ...
        updatedAt: '2026-02-26',
        sections: [
          { id: 'ceo', titleZh: '平台CEO的坚守', titleEn: 'CEO Conviction' },
          { id: 'fundamentals', titleZh: '深耕基本面的定力', titleEn: 'Fundamental Patience' },
          { id: 'minimal', titleZh: '极简策略', titleEn: 'Minimal Strategy' },
          { id: 'hunter', titleZh: '猎手的耐心', titleEn: 'Hunter Patience' },
          { id: 'iron-condor', titleZh: '铁鹰策略的绝对理性', titleEn: 'Iron Condor Rationality' },
        ],
      },
    ],
  },
